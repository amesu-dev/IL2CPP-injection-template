...
{
#pragma region Hooks
	inline void(UNITY_CALLING_CONVENTION SetTargetRecoil)(CombatMaster_Battle_Gameplay_Player_PlayerMovement_o*, float);
	inline void SetTargetRecoil_hk(CombatMaster_Battle_Gameplay_Player_PlayerMovement_o* movement, float recoil) {
...
#pragma region Game Functions
	...
	inline Unity::CCamera* GetMainCamera()
	{
...
inline bool worldtoscreen(Unity::Vector3 world, Vector2& screen)
	{
